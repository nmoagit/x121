...
impl TrashRepo {
    ...
    pub async fn check_parent_trashed(
        ...
        let check = match entity_type {
            ...
            "source_media" => Some(("source_media", "avatar_id", "avatars", "avatar")),
            "derived_media" => Some((
                "derived_media",
                "source_media_id",
                "source_media",
...
fn table_and_name_expr(entity_type: &str) -> (&str, &str) {
    match entity_type {
        ...
        "source_media" => ("source_media", "description"),
        "derived_media" => ("derived_media", "description"),
        "media_variants" => ("media_variants", "variant_label"),
