/**
 * Reusable filter bar for avatar grids (PRD-135).
 *
 * Extracted from ProjectAvatarsTab so both the project tab and
 * Avatar Creator page can share the same filter controls.
 */
...
export interface AvatarFilterBarProps {
  ...
  /** Whether disabled avatars are shown. */
  showDisabled: boolean;
  /** Toggle the show-disabled flag. */
  onToggleShowDisabled: () => void;

  /** Whether avatars with all-green readiness indicators are hidden. */
  ...
  /** Number of selected avatars. Show count + clear when > 0. */
