  ...
  return (
    <div data-testid="import-progress" className="space-y-4">
      ...
      >
        ...
        <CountCard label="Models Created" value={run.characters_created} testId="chars-created" />
        <CountCard label="Models Updated" value={run.characters_updated} testId="chars-updated" />
