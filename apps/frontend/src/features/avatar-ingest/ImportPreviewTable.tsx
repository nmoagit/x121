 ...
 *
 * Dense, scannable table showing all detected avatars with inline editing,
...
import type { AvatarIngestEntry, IngestEntryUpdate, NameConfidence } from "./types";
