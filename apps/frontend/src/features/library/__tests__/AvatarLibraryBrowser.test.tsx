...
import { AvatarLibraryBrowser } from "../AvatarLibraryBrowser";
import type { LibraryAvatar } from "../types";

const MOCK_CHARACTERS: LibraryAvatar[] = [
  {
    id: 1,
    name: "Alice",
    project_id: 10,
...
describe("AvatarLibraryBrowser", () => {
  it("renders the library browser with avatars", async () => {
    renderWithProviders(<AvatarLibraryBrowser />);
  ...
  it("shows avatar cards in a grid", async () => {
    renderWithProviders(<AvatarLibraryBrowser />);
