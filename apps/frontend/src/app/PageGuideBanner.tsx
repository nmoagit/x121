...
const PAGE_GUIDES: Record<string, string> = {
  ...
  "/content/library": "Browse all models across projects in one place. Filter by scene type or track, preview assets, and jump to model details.",
  "/content/scenes": "View and manage individual scene clips. Filter by model, scene type, or status. Import clips or review QA actions.",
  "/content/models": "Manage models across projects. Drop folders to bulk-import seed images and metadata. Click any model to view or upload their seed data.",
  ...
  "/content/model-dashboard": "Per-model readiness dashboard showing image counts, scene progress, metadata status, and blocking issues.",
  "/content/contact-sheet": "Grid view of all approved images for a model — useful for visual consistency checks before delivery.",
  "/content/duplicates": "Detect and resolve duplicate models or assets across projects.",
  ...
  "/production/batch": "Manage batch generation runs across multiple models and scenes simultaneously.",
  ...
  "/reviews": "Your assigned review queue. Start a review to approve or reject model scenes.",
  ...
  "/tools/search": "Full-text search across projects, models, scenes, and prompts.",
  ...
  "/tools/model-ingest": "Bulk-import models from folder structures. Map folders to models, validate, and import.",
  "/tools/batch-metadata": "View and edit metadata across multiple models at once.",
  ...
  "/admin/naming": "Configure automatic naming rules for models, scenes, and files based on project conventions.",
  ...
  "/admin/onboarding-wizard": "Step-by-step wizard for setting up a new project — storage, workflows, scene types, and first model.",
