...
const PAGE_GUIDES: Record<string, string> = {
  ...
  "/projects": "Your projects hub. Each project groups characters, scenes, and deliverables together. Create a new project to get started.",
  ...
  "/content/contact-sheet": "Grid view of all approved images for a character — useful for visual consistency checks before delivery.",
  "/content/duplicates": "Detect and resolve duplicate characters or assets across projects.",
  ...
  "/production/batch": "Manage batch generation runs across multiple characters and scenes simultaneously.",
  ...
  "/review/temporal": "Temporal consistency analysis — detect drift in character appearance across scenes over time.",
  ...
  "/tools/search": "Full-text search across projects, characters, scenes, and prompts.",
  ...
  "/tools/character-ingest": "Bulk-import characters from folder structures. Map folders to characters, validate, and import.",
  "/tools/batch-metadata": "View and edit metadata across multiple characters at once.",
  ...
  "/admin/naming": "Configure automatic naming rules for characters, scenes, and files based on project conventions.",
  ...
  "/admin/onboarding-wizard": "Step-by-step wizard for setting up a new project — storage, workflows, scene types, and first character.",
  ...
  "/admin/disk-usage": "Detailed disk usage breakdown by project, character, and file type.",
