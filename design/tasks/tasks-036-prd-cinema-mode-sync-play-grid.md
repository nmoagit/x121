...
### Task 1.1: Cinema Mode Container
...
**Acceptance Criteria:**
- [ ] Screen background matches dominant colors of video edges
- [ ] Update rate: at least every 100ms during playback
- [ ] Rendering adds <5ms per frame (no perceptible performance impact)
- [ ] Subtle effect — ambiance, not distraction
- [ ] Smooth color transitions between frames

---

## Phase 2: Sync-Play Grid

### Task 2.1: Grid Layout Component
...
- [ ] Toggle between 1x1 (single), 2x1 (side-by-side), and 2x2 (quad) layouts
- [ ] Each cell labeled with segment/variant identifier
- [ ] Drag and drop segments from a list into grid cells
- [ ] Minimal cell borders to maximize viewable area

### Task 2.2: Sync-Play Coordinator
...
- [ ] Speed control affects all cells simultaneously

---

## Phase 3: Grid Controls

### Task 3.1: Global & Per-Cell Controls
...
- [ ] Global transport bar with combined timeline
- [ ] Per-cell audio isolation (mute all except selected)

---

## Phase 4: Review Integration

### Task 4.1: Cinema Mode Review Controls
**File:** `frontend/src/features/cinema/CinemaReviewControls.tsx`

**Acceptance Criteria:**
- [ ] Approve/reject/flag via keyboard shortcuts in cinema mode
...
### Task 5.1: Comprehensive Tests
**File:** `frontend/src/features/cinema/__tests__/`

**Acceptance Criteria:**
- [ ] Ambilight rendering adds <5ms per frame
- [ ] Sync-play grid keeps all cells within 1 frame of each other
- [ ] Cinema mode enters/exits in <300ms
- [ ] Approval actions in cinema/grid mode work correctly
- [ ] Layout switching between 1x1, 2x1, 2x2 works smoothly
- [ ] Auto-hide controls appear on mouse movement and hide after 3s
